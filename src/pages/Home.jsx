  ...
  return (
    <Fragment>
      <Container>
        ...
        >
          <Button
            className="header__top-service__item"
        ...
        <Container>
          <Flex justify={"space-between"}>
            <Cart
              ...
              type={"advertising"}
              image={Advertising1}
              className={`Cart__advertising--lightgrey`}
            ...
            <Cart
              ...
              type={"advertising"}
              image={Advertising2}
              className={`Cart__advertising--lightgreen`}
        ...
        <Container>
          <div className="Sets__row">
            <div className="Sets__content">
              <Title level={"h2"} className={"Sets__title"}>
                BEDSHEET SETS
              </Title>
              <Flex className="Sets__price" align={"center"} gap={21}>
                <Title level={"h2"}>$50.00</Title>
                <Title bodyText={"p"} className={`Sets__price-old`}>
                  $220.00
                </Title>
              </Flex>

              <Title bodyText={"p"} className={`Sets__text`}>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                eiusmod tempor.
              </Title>

              <Btn href={"#"} secondary className={`Sets__link`}>
                VIEW DETAILS
              </Btn>
            </div>
          </div>
      ...
      <section className="Top-rating">
        <Container>
          <Typography.Title level={2} className={`Top-rating__title`}>
            TOP RATING
          </Typography.Title>
          <Flex
            gap={25}
        ...
        <Container>
          <Flex justify={"space-between"}>
            <div className="Sign__description">
              ...
              <Title level={"h3"} className={`Sign__text`}>
